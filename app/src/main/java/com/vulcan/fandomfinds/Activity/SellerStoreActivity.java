...
public class SellerStoreActivity extends AppCompatActivity {
    ...
    private void loadStoreItems() {
        ...
        items.add(new ProductsDomain("T-shirt black","This is a T-shirt black","item_4",7,4.5,500,0,"Maniya Streams",null,"Collectibles"));
        items.add(new ProductsDomain("Apple Watch","This is a Apple Watch","item_2",14,3,200,10,"Maniya Streams",sizes,"Apparel"));
        items.add(new ProductsDomain("Mobile Phone","This is a Mobile Phone","item_3",9,2.1,1200,0,"Maniya Streams",null,"Collectibles"));
        items.add(new ProductsDomain("Samsung TV","This is a Samsung TV","item_4",1,3.4,670,8.3,"Maniya Streams",sizes,"Apparel"));
        items.add(new ProductsDomain("T-shirt black","This is a T-shirt black","item_4",7,4.5,500,0,"Maniya Streams",null,"Collectibles"));
        items.add(new ProductsDomain("Apple Watch","This is a Apple Watch","item_2",14,3,200,10,"Maniya Streams",sizes,"Apparel"));
        items.add(new ProductsDomain("Mobile Phone","This is a Mobile Phone","item_3",9,2.1,1200,0,"Maniya Streams",null,"Collectibles"));
        items.add(new ProductsDomain("Samsung TV","This is a Samsung TV","item_4",1,3.4,670,8.3,"Maniya Streams",sizes,"Apparel"));
